...
# PERMANOVA----
PERM_all_wuni <- adonis2(wuni_dist_all ~ Season3 + Upazila + Culture_system +
...
# Save to Excel
#write_xlsx(permanova_df, "PERMANOVA_results_all_factor_20250215.xlsx")
...
#write_xlsx(pairwise_results_list, "PairwiseAdonis_with_significance_for_all_20250215.xlsx")
