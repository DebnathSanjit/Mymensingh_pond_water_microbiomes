...
pt <- grid.draw(venn_plot_pang.tila)
...
# Draw the Venn diagram
pa.mp <- grid.draw(venn_plot_pang.mp)
...
# Draw the Venn diagram
ti.mp <- grid.draw(venn_plot_tila.mp)
...
# grid.arrange function from gridExtra package works better than grid.draw function
